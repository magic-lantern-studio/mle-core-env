...
/**
 * This class is a test for the class <code>com.wizzer.mle.codegen.TopMakefileTemplate</code>.
 * 
 * @author Mark S. Millard
 */
public class TopMakefileTemplateTest extends TestCase
{
    // The template to test.
    private TopMakefileTemplate m_template = null;
    ...
    {
        junit.textui.TestRunner.run(TopMakefileTemplateTest.class);
    }
    ...
    protected void setUp() throws Exception
    {
        ...
        if (m_template == null)
        {
            m_template = new TopMakefileTemplate();
        }
    }
