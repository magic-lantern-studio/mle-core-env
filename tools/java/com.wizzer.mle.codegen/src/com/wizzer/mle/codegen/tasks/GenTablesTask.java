 ...
 * <i>gentables</i> program.
 * 
 * @author Mark S. Millard
 */
public class GenTablesTask extends Task
{
    // Generate C++ code.
     ...
     * <p>
     * The Magic Lantern <b>gentables</b> task will be initalized to to use the
     * following options:
     * <ul>
    ...
    public void execute()
    {
        ...
        cmdline.setExecutable("gentables");
        StringBuffer commandline = new StringBuffer("gentables");
