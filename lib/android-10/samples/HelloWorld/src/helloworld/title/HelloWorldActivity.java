...
/**
 * This Activity is a simple Android application using the Magic
 * Lantern Runtime Engine.
 */
public class HelloWorldActivity extends Activity
{
    ...
    private static String DEBUG_TAG = "Magic Lantern HelloWorldActivity";
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        {
        	Log.e(DEBUG_TAG, "Unable to parse title resources.");
            System.exit(-1);
        }
        ...
        ((TitleData)(m_title.m_titleData)).m_playprint = m_filename;
    }
    ...
    public void onStart()
    {
    	...
    	Log.i(DEBUG_TAG, "onStart() called.");
        ...
        {
        	Log.e(DEBUG_TAG, "Unable to install shutdown callback.");
            System.exit(-1);            
        }
    ...
    private void init()
    {
        ...
        platformData.m_R = helloworld.title.R.class;
        ...
        Log.i(DEBUG_TAG, "Initializing title registry.");
        ...
        String resourceName = m_filename.substring(0,
        	((TitleData)(m_title.m_titleData)).m_playprint.lastIndexOf('.'));
        Log.i(DEBUG_TAG, "Loading Digital Playprint: " + resourceName + ".");
        try
        {
        ...
        Log.i(DEBUG_TAG, "Creating and initializing stage.");
        try
        {
        ...
        Log.i(DEBUG_TAG, "Loading boot scene.");
        try
        {
