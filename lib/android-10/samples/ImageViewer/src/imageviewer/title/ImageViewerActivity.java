 ...
 * Engine and the Android target library.
 * <p>
...
public class ImageViewerActivity extends Activity
{
    ...
    private static String DEBUG_TAG = "Magic Lantern ImageViewerActivity";
    ...
    private void init()
    {
        ...
        platformData.m_R = imageviewer.title.R.class;
